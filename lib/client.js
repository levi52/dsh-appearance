...
function buildThemeTokens(palette, scheme) {
    const dark = scheme === "dark";
    const ink = (a) => hexToRgba(palette.ink, a);
    const accent = (a) => hexToRgba(palette.accent, a);
    const stateSecondary = (color) => shade(color, dark ? 0.2 : -0.12);
    return {
...
function parseCustomPalette(json) {
    if (!json)
        return null;
    try {
        const obj = JSON.parse(json);
        if (obj && typeof obj.bg === "string" && typeof obj.ink === "string" && typeof obj.accent === "string")
            return obj;
    }
    catch {
        /* invalid JSON — ignore */
...
function customColorScheme(palette) {
...
function resolveWallpaperImage(backgroundImage) {
    if (!backgroundImage)
        return "";
...
function apply(ctx) {
    ...
    function AppearanceSection(props) {
        ...
        async function handleDeleteWallpaper(entry) {
            try {
        ...
        function handleImport(event) {
            ...
            void file.text().then((text) => {
                try {
                    ...
                    const strings = ["theme", "fontFamily", "fontFamilyCustom", "codeFont", "codeFontCustom", "fontSize", "accent", "accentCustom", "backgroundImage", "customTheme", "customThemeName"];
                    for (const field of strings)
                        if (typeof obj[field] === "string")
                            next[field] = obj[field];
                    const numbers = ["bgOpacity", "bgBlur"];
            ...
            reader.onload = async () => {
                ...
                try {
                    ...
                    if (response.ok) {
                        const payload = (await response.json());
                        if (payload.url) {
                            setDraft((d) => ({ ...d, backgroundImage: payload.url }));
                            void loadWallpapers();
                            return;
                        }
                    }
        ...
        return React.createElement("div", { className: "dshApp-shell" }, React.createElement("div", { className: "dshApp-section" }, React.createElement("div", { className: "dshApp-sectionTitle" }, t("themeSection")), React.createElement("div", { className: "dshApp-hint" }, t("themeHint")), React.createElement("div", { className: "dshApp-grid" }, ...themeCards.map((card) => React.createElement("button", {
        ...
        }, theme === card.id ? React.createElement("span", { className: "dshApp-check" }, "✓") : null, React.createElement("div", { className: "dshApp-swatches" }, ...card.swatches.map((color, i) => React.createElement("span", { key: i, className: "dshApp-swatch", style: { background: color } }))), React.createElement("span", { className: "dshApp-cardName" }, card.label)))), React.createElement("button", { type: "button", className: "dshApp-segBtn", onClick: openCustomEditor }, t("customEdit")), editingCustom && editPalette
            ? React.createElement("div", { className: "dshApp-customEditor" }, React.createElement("input", {
                className: "dshApp-input",
                type: "text",
                value: draft.customThemeName || "",
                placeholder: t("customNameLabel"),
                onChange: (e) => setDraft((d) => ({ ...d, customThemeName: e.target.value }))
            }), React.createElement("div", { className: "dshApp-customRow2" }, React.createElement("span", { className: "dshApp-hint" }, t("customColorBg")), React.createElement("input", { type: "color", className: "dshApp-accentCustomInput", value: editPalette.bg, onChange: (e) => setEditColor("bg", e.target.value) })), React.createElement("div", { className: "dshApp-customRow2" }, React.createElement("span", { className: "dshApp-hint" }, t("customColorSurface")), React.createElement("input", { type: "color", className: "dshApp-accentCustomInput", value: editPalette.surface, onChange: (e) => setEditColor("surface", e.target.value) })), React.createElement("div", { className: "dshApp-customRow2" }, React.createElement("span", { className: "dshApp-hint" }, t("customColorInk")), React.createElement("input", { type: "color", className: "dshApp-accentCustomInput", value: editPalette.ink, onChange: (e) => setEditColor("ink", e.target.value) })), React.createElement("div", { className: "dshApp-customRow2" }, React.createElement("span", { className: "dshApp-hint" }, t("customColorAccent")), React.createElement("input", { type: "color", className: "dshApp-accentCustomInput", value: editPalette.accent, onChange: (e) => setEditColor("accent", e.target.value) })), React.createElement("div", { className: "dshApp-customRow2" }, React.createElement("span", { className: "dshApp-hint" }, t("customColorBorder")), React.createElement("input", { type: "color", className: "dshApp-accentCustomInput", value: editPalette.border.startsWith("#") ? editPalette.border : "#666666", onChange: (e) => setEditColor("border", e.target.value) })), React.createElement("button", { type: "button", className: "dshApp-save", onClick: commitCustomTheme }, t("customUse")))
            : null), React.createElement("div", { className: "dshApp-section" }, React.createElement("div", { className: "dshApp-sectionTitle" }, t("uiFont")), React.createElement("div", { className: "dshApp-hint" }, t("uiFontHint")), seg([
        ...
        }))), React.createElement("div", { className: "dshApp-section" }, React.createElement("div", { className: "dshApp-sectionTitle" }, t("bgImageTitle")), React.createElement("div", { className: "dshApp-hint" }, t("bgImageHint")), React.createElement("div", { className: "dshApp-wallpaperRow" }, React.createElement("div", {
        ...
        }), React.createElement("label", { className: "dshApp-pickBtn" }, t("bgImageUpload"), React.createElement("input", {
            type: "file",
            accept: "image/*",
            style: { display: "none" },
            ...
            onChange: (e) => setDraft((d) => ({ ...d, backgroundImage: e.target.value }))
            ...
            : null, wallpapers.length > 0
            ? React.createElement("div", { className: "dshApp-wallGrid" }, ...wallpapers.map((entry) => React.createElement("div", { key: entry.filename, className: "dshApp-wallItem" + (backgroundImage === entry.url ? " dshApp-wallSelected" : "") }, React.createElement("button", {
                type: "button",
            ...
            : null, React.createElement("div", { className: "dshApp-sliderRow" }, React.createElement("span", { className: "dshApp-hint" }, t("bgOpacityLabel")), React.createElement("input", {
            type: "range",
            min: 0,
            max: 100,
            value: bgOpacity,
            ...
            onChange: (e) => setDraft((d) => ({ ...d, bgOpacity: Number(e.target.value) }))
        }), React.createElement("span", { className: "dshApp-sliderVal" }, `${bgOpacity}%`)), React.createElement("div", { className: "dshApp-sliderRow" }, React.createElement("span", { className: "dshApp-hint" }, t("bgBlurLabel")), React.createElement("input", {
            type: "range",
            min: 0,
            max: 30,
            value: bgBlur,
            disabled: !backgroundImage,
            className: "dshApp-slider",
            onChange: (e) => setDraft((d) => ({ ...d, bgBlur: Number(e.target.value) }))
        }), React.createElement("span", { className: "dshApp-sliderVal" }, `${bgBlur}px`))), React.createElement("div", { className: "dshApp-section dshApp-actions" }, React.createElement("div", { className: "dshApp-hint" }, dirty ? t("dirtyHint") : t("savedHint")), React.createElement("div", { className: "dshApp-actionRow" }, React.createElement("button", { type: "button", className: "dshApp-save", disabled: !dirty, onClick: save }, t("saveButton")), React.createElement("button", { type: "button", className: "dshApp-reset", disabled: !dirty, onClick: discard }, t("discardButton")), React.createElement("button", { type: "button", className: "dshApp-reset", onClick: resetDraft }, t("reset")), React.createElement("button", { type: "button", className: "dshApp-reset", title: t("exportHint"), onClick: exportSettings }, t("exportButton")), React.createElement("label", { className: "dshApp-pickBtn", title: t("importHint") }, t("importButton"), React.createElement("input", { type: "file", accept: ".json,application/json", style: { display: "none" }, onChange: handleImport })))), fontPicker !== null
    ...
    // palette changes.
    let customThemeDispose;
    function registerCustomTheme(palette) {
    ...
    function quickApplyAccent(id) {
        scope.set("accent", id);
        applyAccentOverride({ accent: id, accentCustom: "" });
    }
    /** Full-screen wallpaper + translucent surface layer so it shows through. */
    let wallpaperDispose;
    let wallpaperDiv;
    let wallpaperOpacity = 100;
    let wallpaperBlur = 0;
    function ensureWallpaperDiv() {
        if (!wallpaperDiv) {
     ...
     */
    function wallpaperSurfaceLayer(opacity) {
        ...
        const alpha = (floor) => Math.round((1 - (1 - floor) * o) * 100) / 100;
        const layer = (a) => `rgba(${rgb},${a})`;
        return {
     ...
     */
    function QuickThemeSwitch(props) {
        const { t: tq, wide } = props;
        const [open, setOpen] = React.useState(false);
        const quickValue = React.useSyncExternalStore((cb) => scope.subscribe(cb), () => scope.getSnapshot().value);
        ...
        return React.createElement("div", { className: "dshApp-quick" }, React.createElement("button", {
            type: "button",
            ref: btnRef,
            className: "dshApp-quickBtn",
            onClick: toggleMenu
        }, React.createElement("span", { className: "dshApp-quickDot", style: { background: accentDot ?? "var(--dsw-alias-brand-primary)" } }), wide ? React.createElement("span", null, tq("quickTitle")) : null), open && menuPos
            ? React.createElement("div", { className: "dshApp-quickMenu", style: { left: menuPos.left, bottom: menuPos.bottom, position: "fixed" } }, React.createElement("div", { className: "dshApp-hint" }, tq("themeSection")), ...chips.map((chip) => React.createElement("button", {
                key: chip.id,
                type: "button",
                className: "dshApp-quickChip",
                "data-selected": String(currentTheme === chip.id),
                onClick: () => { quickApplyTheme(chip.id); setOpen(false); }
            }, chip.label)), React.createElement("div", { className: "dshApp-hint" }, tq("quickAccent")), React.createElement("div", { className: "dshApp-quickAccentRow" }, React.createElement("button", {
                type: "button",
                className: "dshApp-accentSwatch",
            ...
            }), ...ACCENT_PRESETS.map((preset) => React.createElement("button", {
                key: preset.id,
                type: "button",
                className: "dshApp-accentSwatch",
                style: { background: preset.light },
